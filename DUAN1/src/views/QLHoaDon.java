...
public class QLHoaDon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblHoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã hóa đơn", "Tên nhân viên", "Tên khách hàng", "Ngày tạo", "Ngày thanh toán", "Mã khuyến mãi", "Tổng tiền", "Trạng thái"
            }
        ) {
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        ...
        tt = "Đã thanh toán";
        String cautruyvan = "update HoaDon set MaKhuyenMai=" + MaKM + ",TrangThai=N'" + tt + "',NgayThanhToan=N'" + ngaytt + "' where MaHoaDon=" + MaHD;
